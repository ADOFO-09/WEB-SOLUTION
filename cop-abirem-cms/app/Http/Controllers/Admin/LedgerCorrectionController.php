...
class LedgerCorrectionController extends Controller
{
    ...
    public function voidTithe(Request $request, Tithe $tithe)
    {
        ...
        LedgerAuditLog::create([
            ...
            'entry_id'     => $tithe->id,
            'action'       => 'voided',
            'old_values'   => ['ledger_status' => 'active'],
            'new_values'   => ['ledger_status' => 'voided', 'void_reason' => $request->reason],
    ...
    public function restore(Request $request, string $type, int $id)
    {
        ...
        LedgerAuditLog::create([
            ...
            'entry_id'     => $id,
            'action'       => 'restored',
            'old_values'   => ['ledger_status' => 'voided'],
            'new_values'   => ['ledger_status' => 'active'],
    ...
    public function createAdjustment(Request $request, string $type, int $id)
    {
        ...
        LedgerAuditLog::create([
            ...
            'entry_id'     => $id,
            'action'       => 'adjusted',
            'old_values'   => ['amount' => $oldAmount, 'ledger_status' => 'active'],
            'new_values'   => ['amount' => $request->amount, 'ledger_status' => 'adjusted', 'adjustment_ref' => $adjustment->reference_number],
            'reason'       => $request->reason,
            'performed_by' => auth()->id(),
            'ip_address'   => request()->ip(),
            'user_agent'   => request()->userAgent(),
