...
@section('title', 'Funeral Due Contributions')

@section('header')
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
        <h1 class="text-2xl font-bold text-gray-900">Funeral Due Contributions</h1>
        @if(auth()->user()->hasPermission('funeral.create'))
        <div class="mt-4 sm:mt-0">
            <a href="{{ route('admin.funeral.contributions.create') }}"
...
@section('content')
    ...
    <div class="bg-white rounded-lg shadow mb-6">
        <div class="p-4">
            <form action="{{ route('admin.funeral.contributions.index') }}" method="GET"
                ...
                <div class="flex space-x-2">
                    ...
                    <a href="{{ route('admin.funeral.contributions.index') }}" class="px-3 py-2 border border-gray-300 rounded-md hover:bg-gray-50 text-sm">
                        Clear
                    </a>
                </div>
            </form>
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-4 py-3 whitespace-nowrap text-right text-sm font-medium">
                            <div class="flex items-center justify-end space-x-2">
                                <a href="{{ route('admin.funeral.contributions.show', $contribution) }}" class="text-indigo-600 hover:text-indigo-900">View</a>
                                @if(auth()->user()->hasPermission('funeral.edit'))
                                <a href="{{ route('admin.funeral.contributions.edit', $contribution) }}" class="text-yellow-600 hover:text-yellow-900">Edit</a>
                                @endif
                                @if(auth()->user()->hasPermission('funeral.delete'))
                                <form method="POST" action="{{ route('admin.funeral.contributions.destroy', $contribution) }}"
                    ...
                    <tr>
                        <td colspan="8" class="px-6 py-12 text-center text-gray-500">
                            ...
                            No funeral due contributions found.
                        </td>
                    </tr>
                    @endforelse
                </tbody>
