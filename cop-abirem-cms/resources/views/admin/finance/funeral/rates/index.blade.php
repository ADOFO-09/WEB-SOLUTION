...
@section('title', 'Funeral Due Rates')

@section('header')
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
        <h1 class="text-2xl font-bold text-gray-900">Funeral Due Rates</h1>
    </div>
@endsection
...
@section('content')
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div class="bg-white rounded-lg shadow">
            ...
            <form action="{{ route('admin.funeral.rates.store') }}" method="POST" class="p-6 space-y-4">
                @csrf
                <div>
