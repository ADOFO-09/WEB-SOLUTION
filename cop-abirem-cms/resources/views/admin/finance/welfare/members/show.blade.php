...
@section('title', 'Welfare Records — '.$member->first_name.' '.$member->last_name)
            ...
            <div>
                ...
                <div style="margin-top:0.4rem;">
                    ...
                    <span style="background:#dcfce7;color:#166534;font-size:0.7rem;font-weight:700;padding:0.15rem 0.55rem;border-radius:12px;">
                        Welfare Enrolled{{ $member->welfare_start_date ? ' — since '.$member->welfare_start_date->format('M Y') : '' }}
                    </span>
                    @else
...
<div style="margin-bottom:0.75rem;">
    <a href="{{ route('admin.welfare.members.index') }}" style="font-size:0.82rem;color:#64748b;">&larr; Back to Member Records</a>
</div>
    ...
    <div style="padding:1rem 1.25rem;overflow-x:auto;">
        <div style="display:grid;grid-template-columns:repeat(12,1fr);gap:0.3rem;min-width:560px;">
            ...
            <div style="background:{{ $bg }};border-radius:6px;padding:0.45rem 0.25rem;text-align:center;"
                ...
                <div style="font-size:0.62rem;font-weight:700;color:{{ $fc }};overflow:hidden;white-space:nowrap;text-overflow:ellipsis;" title="{{ $lbl }}">{{ $lbl }}</div>
            </div>
            @endforeach
        </div>
...
<div style="background:#fff;border-radius:12px;overflow:hidden;box-shadow:0 1px 4px rgba(0,0,0,0.06);">
    @if($benefits->isEmpty())
    <div style="padding:2.5rem;text-align:center;color:#9ca3af;font-size:0.875rem;">No welfare benefits recorded for this member.</div>
    @else
        ...
        <table style="width:100%;font-size:0.82rem;border-collapse:collapse;">
            ...
            <tbody>
                ...
                <tr style="border-bottom:1px solid #f8fafc;">
                    ...
                    <td style="padding:0.6rem 1rem;color:#64748b;max-width:220px;">
                    ...
                    <td style="padding:0.6rem 1rem;text-align:right;">
                        <a href="{{ route('admin.welfare.benefits.show', $benefit) }}"
