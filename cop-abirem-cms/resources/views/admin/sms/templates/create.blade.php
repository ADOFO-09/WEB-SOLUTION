...
@section('header')
    <div class="flex items-center">
        ...
        <h1 class="text-2xl font-bold text-gray-900">New SMS Template</h1>
    </div>
@endsection
...
<div class="max-w-2xl mx-auto">
    <form action="{{ route('admin.sms.templates.store') }}" method="POST" class="space-y-6">
        ...
        <div class="bg-white shadow rounded-lg" x-data="templateEditor(@js(old('content', '')))">
            ...
            <div class="p-6 space-y-4">
                ...
                @include('admin.sms.templates._form_content', ['content' => old('content', ''), 'uiRegistry' => $uiRegistry])
