    ...
    <div class="card" style="margin-bottom: 1.5rem;">
        ...
        <div class="card-body">
            <div class="form-group">
                ...
                <input type="text" name="name" class="form-input" value="{{ old('name') }}" required style="max-width: 400px;">
                @error('name')<p class="form-error">{{ $message }}</p>@enderror
            </div>
            
            <div class="form-group">
                <label class="form-label">Description</label>
                <textarea name="description" class="form-textarea" rows="3" style="max-width: 600px;">{{ old('description') }}</textarea>
            </div>
        </div>
    </div>
