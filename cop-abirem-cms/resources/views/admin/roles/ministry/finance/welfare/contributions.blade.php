...
<div class="mb-6 flex items-center justify-between">
    ...
    <div style="display:flex;gap:0.75rem;align-items:center;">
        <a href="{{ route('admin.ministry.finance.welfare.contributions.pdf', request()->only(['period_year','period_month','member_id'])) }}" class="btn btn-secondary" title="Export PDF">
