...
<body class="h-full" x-data="{ sidebarOpen: false }">
    ...
    <div class="main-content">
        ...
        <header class="top-nav">
            ...
            {{-- Right side: tour button + date --}}
            <div style="display:flex;align-items:center;gap:0.75rem;">
                <button onclick="window.startGuidedTour && window.startGuidedTour()"
                        data-tour="member-topnav-tour"
                        title="Take a guided tour"
                        style="display:inline-flex;align-items:center;gap:0.35rem;font-size:0.75rem;font-weight:600;color:#4f46e5;background:#eef2ff;border:1px solid #c7d2fe;border-radius:8px;padding:0.35rem 0.75rem;cursor:pointer;white-space:nowrap;font-family:inherit;transition:background 0.2s;"
